...
class Application(tk.Frame):
    def __init__(self):
        ...
        self.panMid = tk.LabelFrame(self.frameAll, text='目标数据', relief='sunken', font=('宋体', 18), pady=5)
        ...
        # Mid区域——数据输入
        self.frameDataInput = tk.LabelFrame(self.panMid, text='直接输入数据', font=('宋体', 18), relief='sunken')
        self.frameDataInput.pack(fill='both', expand=1, side=tk.LEFT)
    ...
    def SetFrameData(self):
        #-------------------- 直接输入 --------------------#
        # 目标经度/真值精度
        self.lonTargetLabel = tk.Label(self.frameDataInput, text=' 真值经度', font=('宋体', 15), pady=5)
        self.lonTarEntry = tk.Entry(self.frameDataInput, font=('宋体', 15), width=13)
        
        # 目标纬度/真值纬度
        self.latTargetLabel = tk.Label(self.frameDataInput, text='  真值纬度', font=('宋体', 15), pady=5)
        self.latTarEntry = tk.Entry(self.frameDataInput, font=('宋体', 15), width=13)
        
        # 目标横坐标/检测经度
        self.xTargetLabel = tk.Label(self.frameDataInput, text='横坐标', font=('宋体', 15), pady=5)
        self.xTarEntry = tk.Entry(self.frameDataInput, font=('宋体', 15), width=13)

        # 目标纵坐标/检测纬度
        self.yTargetLabel = tk.Label(self.frameDataInput, text=' 纵坐标', font=('宋体', 15), pady=5)
        self.yTarEntry = tk.Entry(self.frameDataInput, font=('宋体', 15), width=13)
        
        # 雷达经度/主基站北向夹角
        self.lonLidarLabel = tk.Label(self.frameDataInput, text='  雷达经度', font=('宋体', 15), pady=8)
        self.lonLidarEntry = tk.Entry(self.frameDataInput, font=('宋体', 15), width=15)

        # 雷达纬度/副基站北向夹角
        self.latLidarLabel = tk.Label(self.frameDataInput, text='  雷达纬度', font=('宋体', 15), pady=8)
        self.latLidarEntry = tk.Entry(self.frameDataInput, font=('宋体', 15), width=15)
